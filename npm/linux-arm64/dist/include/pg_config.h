...
#define CONFIGURE_ARGS " 'CFLAGS=-Os -DMAP_HUGETLB=0x40000' 'PYTHON=/usr/bin/python3' '--prefix=/usr/local/pg-build' '--enable-integer-datetimes' '--enable-thread-safety' '--with-ossp-uuid' '--with-icu' '--with-libxml' '--with-libxslt' '--with-openssl' '--with-perl' '--with-python' '--with-tcl' '--without-readline'"
...
#define PG_VERSION_STR "PostgreSQL 15.6 on aarch64-unknown-linux-gnu, compiled by gcc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0, 64-bit"
